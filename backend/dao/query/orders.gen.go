...
func newOrder(db *gorm.DB, opts ...gen.DOOption) order {
	...
	_order.UserID = field.NewInt(tableName, "user_id")
	_order.ProductID = field.NewInt(tableName, "product_id")
	_order.LemonOrderID = field.NewString(tableName, "lemon_order_id")
	_order.AmountCents = field.NewInt(tableName, "amount_cents")
	...
	_order.ShippingInfo = field.NewString(tableName, "shipping_info")
	_order.TrackingNumber = field.NewString(tableName, "tracking_number")
	_order.CustomerNote = field.NewString(tableName, "customer_note")
...
type order struct {
	...
	ALL               field.Asterisk
	ID                field.Int    // 订单主键ID
	OrderNo           field.String // 系统内部业务订单号(全局唯一)
	UserID            field.Int    // 购买者用户ID
	ProductID         field.Int    // 关联商品ID
	LemonOrderID      field.String // Lemon Squeezy官方交易订单ID
	AmountCents       field.Int    // 实付总金额(美分)
	Currency          field.String // 结算币种(默认USD)
	PaymentStatus     field.String // 支付状态: pending(待支付) / paid(已支付) / refunded(已退款)
	FulfillmentStatus field.String // 履约发货状态: unfulfilled(待发货/待开通) / fulfilled(已完成)
	ShippingInfo      field.String // 买家收件信息JSON(姓名、国家代码、详细街道、城市、州/省、邮编、电话)
	TrackingNumber    field.String // 国际物流快递单号(实物订单发货填写)
	CustomerNote      field.String // 买家下单备注
	Metadata          field.String // 扩展字段: Lemon Squeezy原始Webhook Payload镜像备份
...
func (o *order) updateTableName(table string) *order {
	...
	o.ProductID = field.NewInt(table, "product_id")
	o.LemonOrderID = field.NewString(table, "lemon_order_id")
	o.AmountCents = field.NewInt(table, "amount_cents")
	...
	o.ShippingInfo = field.NewString(table, "shipping_info")
	o.TrackingNumber = field.NewString(table, "tracking_number")
	o.CustomerNote = field.NewString(table, "customer_note")
...
func (o *order) fillFieldMap() {
	...
	o.fieldMap["lemon_order_id"] = o.LemonOrderID
	...
	o.fieldMap["shipping_info"] = o.ShippingInfo
	o.fieldMap["tracking_number"] = o.TrackingNumber
	o.fieldMap["customer_note"] = o.CustomerNote
