...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Credits = field.NewInt(tableName, "credits")
...
type user struct {
	...
	ALL          field.Asterisk
	ID           field.Int    // 用户主键ID
	Email        field.String // 登录邮箱(唯一)
	PasswordHash field.String // Bcrypt加密密码(OAuth用户可为空)
	Role         field.String // 角色权限: user(普通用户) / admin(超级管理员)
	AvatarURL    field.String // 用户头像CDN链接
	Credits      field.Int    // AI调用点数/可用额度
	GoogleID     field.String // Google OAuth唯一用户标识
	Metadata     field.String // 扩展字段: 用户画像、偏好设置等
...
func (u *user) updateTableName(table string) *user {
	...
	u.Credits = field.NewInt(table, "credits")
